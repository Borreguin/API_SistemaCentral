...
"""
    ...
    Cada Parse indica como se deben observar los modelos desde afuera, explicación de los parámetros
    de la API en su página inicial (permite la autodocumentación de la API)
"""

# add the definition for parser
